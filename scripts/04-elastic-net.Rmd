---
title: "Elastic Net: Implementation and Tuning"
author: "Will Doyle"
date: "2026-01-20"
...
Now that we've gone through ridge and lasso you may be wondering which to choose. The good news is you don't have to choose!
...
The key here is to use hyperparameter tuning to choose a combination of mixture (alpha) and penalty (lambda) to minimize loss. 
...
Remember as always that these aren't regression coefficients in the way we've grown used to thinking about them. 
They're the combination of betas from the above algorithm that provides the most accurate model fit in our training data. 
...
Make sure you're clear on the difference between the structural parameter estimates we're used to thinking about in psychometrics or econometrics and the variable importance we're using here. It comes down to predictive thinking versus measurement/evaluation thinking.
