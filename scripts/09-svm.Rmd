...
Support vectors are the **critical data points** that define the margin. These are: - **Points on the margin boundaries**. - **Misclassified points (in soft-margin SVMs)**.
