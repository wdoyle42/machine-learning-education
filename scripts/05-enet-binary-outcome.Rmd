...
Just using this kind of conditional mean approach shows the substantial variation in four-year attendance by income. As we add in more features we *should* be able to improve performance over the baseline. 
