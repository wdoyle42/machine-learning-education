...
Let's take the lasso and apply it to our high school example, using lasso to predict GPA.
...
Using the same setup as we did with regression, we'll ad the predictions from the lasso model to the test dataset.
...
hs_test%>%
  rmse(truth=x3tgpatot,estimate=.pred...2)
```
